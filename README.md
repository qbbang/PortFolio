...
POS 업체 변경에 따른 RS-422 통신 parsing 정보 수정과 같이, 살을 덧붙이거나 빼거나 하는 반복 작업 후 인증 심사 진행의 반복이였습니다.

일정에 쫓겨가며 인증을 진행하고 뒤돌아보니 3년이 지났고, 기술 발전은 없고 성취감도 없었습니다.

그래서 처음부터 다시 배우는 마음과 최첨단으로 가자는 생각을 가지고 iOS 교육, 인턴과정 등을 통해 Moblie 앱 개발자로 막 발 디딘 사람입니다
...
개발을 진행해야 하는 부분이 많았는데, 별도의 시간을 할애 해줘서 처리해주거나, 아니면 직접 방문해서 그 자리에서 해결하는 케이스도 있었습니다.
