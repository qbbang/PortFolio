...
## 🧑🏻‍💻  디프만(디자이너와 프로그래머가 만났을 때) 9기 - 회장, 2021.01 ~ 2021. 06

###  👉 역할 👈

    - 서비스 런칭 성공률을 높이기 위한 프로세스 개선 
      : 정확한 가이드 라인
    - 전반적인 동아리 운영 및 안내(소통창구)     
    
----
 
 
## 🏢 KST모빌리티 - "iOS 개발자", 2020.10.19 ~ ing`   

### 👉 진행된 업무들 👈 　

    - 간단한 UI 이슈 및 QA 진행 `2020.10.19 - 2020.11. 4`
      : 메모리 누수가 발생하여 해당 문제 처리 + 모든 Warning 제거
    
    - 마카롱 M 리뉴얼 2차 `2020.11.4 - 2020.11. 25`
    
    - 마카롱 M 리뉴얼 3차 `2020.11.25 - 2020.12. 18`

    - 유지보수, 개발환경 개선 및 SSE 기능 추가  `2020.12.28 ~ ing`
    
    - 호출 수 향상을 위한 앱클립 검증 + 환경 ~ 구현  `2021.4.15 ~ 2021.6.14` 
    
    - 서비스 확대를 위한 SDK 작업 `2021.6.14 ~ ing`
    
----
  

## 🧑🏻‍💻  디프만(디자이너와 프로그래머가 만났을 때) 8기 - "iOS 개발자", 2020.07 ~ 2020.12
...
## 🧑🏻‍💻  디프만(디자이너와 프로그래머가 만났을 때) 8기 - "iOS 개발자", 2020.07 ~ 2020.08
