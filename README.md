...
SW 길을 걷고자, Automotive 컴파일러 기술지원 1년, Qt Framework를 이용하여 셀프 주유기 GUI 프로그램 개발 3년을 거쳤습니다.

QT를 사용하여 3년간 개발하면서,  개정으로 인해 처음 개발한 IC 전환 프로젝트 외 나머지 16개의 프로젝트는

기본 베이스에 정유사 업체 변경에 따른 UI 수정, VAN 업체 변경에 따른 리더기 SR-232리더기RS-232 통신 parsing 정보 수정,

POS 업체 변경에 따른 ?RS-422 통신 parsing 정보 수정과 같이,

살을 덧붙이거나 빼거나 하는 반복 작업 후 인증 심사 진행를 하다보니,

SW를 시작하면서 처음 생각한 방향과 많이 다른 모습에, 좀 더 흥미롭고 주도적인 개발, 조금 더 사용자 경험을 사용자에게 제공하고,
...
강남구의 고정식 이동카메라의 위치 공동데이터를 가지고 반경 100m 안에 정차하게 되면 5분 타이머를 작동하는 앱을 구현 했고,
