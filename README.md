...
SW 길을 걷고자, Automotive 컴파일러 기술지원 1년를 하고, 
...
살을 덧붙이거나 빼거나 하는 반복 작업 후 인증 심사 진행를 하다보니,
...
추가적으로 해당 앱서비스의 앱재사용율을 높히기 위한 기획을 인턴과제로 받아, 병원/약국 찾기 외 사용자들이

앱을 주도적으로 사용할 있도록, 건강 관련 부가서비스를 기획하였고,

"간헐적 단식"이라는 아이템을 기획하고 디자인, 구현까지 진행하였습니다.

구현에 있어 API는 직접 설계하였고, 기획 바탕으로 프로토타입을 ?Adodb  만들어 실제 구현에 참고하여
